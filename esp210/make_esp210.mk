...
PROJ_ROOT                   := < add your path e.g. .../physical_device/esp210>
TOOLS_PATH                  := $(PROJ_ROOT)/Arduino15/packages/esp8266/tools
ARDUINO_PATH                := $(PROJ_ROOT)
PROJ_PATH                   := $(PROJ_ROOT)/source
...
# e.g. if you would use WiFi and send datagram over UDP
#PROJ_SPEC_SYS_INC           := $(shell find $(RUNTIME_PLATFORM_PATH)/libraries/ESP8266WiFi/src -name "*.h")
#PROJ_SPEC_SYS_SRC           := $(RUNTIME_PLATFORM_PATH)/libraries/ESP8266WiFi/src/
...
TEMP_CORE_PATHS             += $(PROJ_SPEC_SYS_SRC)
VPATH                       := $(TEMP_PROJ_PATHS) 
VPATH                       += $(TEMP_CORE_PATHS)


# Objects - Note, the linker script found at "https://github.com/esp8266/Arduino/..." need the source
